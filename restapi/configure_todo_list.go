...
import (
	...
	"simple-server/restapi/operations"
	"simple-server/restapi/operations/todos"
)

//go:generate swagger generate server --target ../../simple_server --name TodoList --spec ../swagger.yml
